            ...
            <div class="flex h-full space-x-8">
              <div class="flex">
                <div class="absolute inset-x-0 top-full text-lg text-white">
                  <div class="relative bg-gradient-to-l from-violet-500 via-fuchsia-500 to-fuchsia-500">
                    <div class="mx-auto max-w-7xl px-8">
                      <div class="grid grid-cols-2 gap-y-1 gap-x-8 py-8">
                        <div class="row-start-1 grid grid-cols-3 gap-y-10 gap-x-20 text-sm">
                          <div>
                            <p  class="font-bold text-xl  divide-slate-50 text-gray-50">Categories</p>
                            <div  class="border-b border-gray-50 pt-2"/>
                            <div className='row-start-1 grid grid-cols-3 gap-y-10 gap-x-20 text-sm'>
                                <div>
                          ...
                          <div>
                            <p  class="font-bold text-xl  divide-slate-50 text-gray-50">Stickers</p>
                            <div  class="border-b border-gray-50 pt-2"/>
                          ...
                          <div>
                            <p  class="font-bold text-xl  divide-slate-50 text-gray-50">Favorites</p>
                            <div  class="border-b border-gray-50 pt-2"/>
