...
import { fetchGetGifs, fetchGetItemById, fetchGetTagsRelated } from "/src/api/giphyApi";
import {
  onShowItem,
  onSearchingItemById,
  onClearSearch,
...
export const useGetItemById = () => {
  ...
  const { item, item_id, itemTags, tagsTerms, itemGifsRelated, user } =
    useSelector((state) => state.showItem);
